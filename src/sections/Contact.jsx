...
const Contact = () => {
  ...
  return (
    <div
      id="contact"
      className="w-full bg-gray-300 lg:px-170px] px-[20px] lg:pt-[150px] pt-[70px] pb-[100px] flex flex-col justify-center items-center gap-[150px]"
    >
      {/* list row */}
      <div
        data-aos="zoom-in"
      ...
      <div className="w-full flex lg:flex-row flex-col justify-center items-center mt-[40px] lg:gap-[0px] gap-[60px]">
        ...
        >
          <img
            src={contactimg}
            alt="contact image"
            className="lg:mg-[_190px] lg:ml-[-50px] bg-cover bg-center"
          />
        </div>
      </div>
      {/* 2nd row */}
